...
#define VER_GLSL_FILE "../../../3.3.模型/box.vert"
#endif

#ifndef FRG_GLSL_FILE
#define FRG_GLSL_FILE "../../../3.3.模型/box.frag"
#endif

#ifndef LIGFRG_GLSL_FILE
#define LIGFRG_GLSL_FILE "../../../3.3.模型/light.frag"
#endif

#ifndef LIGVER_GLSL_FILE
#define LIGVER_GLSL_FILE "../../../3.3.模型/light.vert"
#endif

#ifndef MODFRG_GLSL_FILE
#define MODFRG_GLSL_FILE "../../../3.3.模型/model.frag"
#endif

#ifndef MODVER_GLSL_FILE
#define MODVER_GLSL_FILE "../../../3.3.模型/model.vert"
#endif
...
int main()
{
    ...
    std::string modPath = MODEL_DIR;
    modPath += "/nanosuit/nanosuit.obj";
    Model obj(modPath);
    Shader objShader(MODVER_GLSL_FILE, MODFRG_GLSL_FILE);
