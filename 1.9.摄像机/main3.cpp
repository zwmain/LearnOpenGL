...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "1.9.Camera", NULL, NULL);
    if (window == NULL)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        unsigned int modelLoc = glGetUniformLocation(sdr.ID, "model");
        unsigned int viewLoc = glGetUniformLocation(sdr.ID, "view");
        unsigned int projectionLoc = glGetUniformLocation(sdr.ID, "projection");
